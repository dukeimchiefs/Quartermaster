...
from real_schedule import ambulatory, assist_list, available_clinics, checks, common, fsc_tracker, inpatient_schedule, master_schedule, roster

_MODULES = [common, roster, master_schedule, ambulatory, assist_list, available_clinics, fsc_tracker, inpatient_schedule, checks]
