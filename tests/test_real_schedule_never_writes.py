...
from real_schedule import ambulatory, assist_list, available_clinics, checks, common, fsc_tracker, master_schedule

_MODULES = [common, master_schedule, ambulatory, assist_list, available_clinics, fsc_tracker, checks]
