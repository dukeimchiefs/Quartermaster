...
these files at runtime, for the five schedule-verification tools (Check
Assist Swap, Check Clinic Coverage, Check FSC/Reflection Day, Check
Rotation Swap, Check Day Off Alignment — see
`app/pages/4_Check_Assist_Swap.py` / `5_Check_Clinic_Coverage.py` /
`6_Check_FSC_Reflection_Day.py` / `7_Check_Rotation_Swap.py` /
`8_Check_Day_Off_Alignment.py`). This is a deliberate decision made
